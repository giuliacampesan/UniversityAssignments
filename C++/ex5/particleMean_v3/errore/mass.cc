...
/*const double massPion = Constants.masspion();   // GeV/c^2
const double massProton  =  Constants.massproton();    // GeV/c^2
const double massK0 = Constants.masskaon();    // GeV/c^2
const double massLambda0 = Constants.masslambda();    // GeV/c^2*/
